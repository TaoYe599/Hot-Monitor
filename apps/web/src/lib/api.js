...
export const api = {
    ...
    createSubscriptionRule(body) {
        return request("/api/subscriptions", {
            method: "POST",
            body: JSON.stringify(body),
        });
    },
    updateSubscriptionRule(id, body) {
        return request(`/api/subscriptions/${id}`, {
            method: "PATCH",
            body: JSON.stringify(body),
        });
    },
    deleteSubscriptionRule(id) {
        return request(`/api/subscriptions/${id}`, {
            method: "DELETE",
        });
    },
    testSubscriptionRuleNotification(id) {
        return request(`/api/subscriptions/${id}/test-notification`, {
            method: "POST",
            body: JSON.stringify({}),
        });
    },
    ...
    cleanupSettings(body = {}) {
        return request("/api/settings/cleanup", {
            method: "POST",
            body: JSON.stringify(body),
        });
    },
